...
## Summary
- 1699 nodes · 5218 edges · 44 communities detected
- Extraction: 63% EXTRACTED · 37% INFERRED · 0% AMBIGUOUS · INFERRED: 1939 edges (avg confidence: 0.76)
...
4. `FileExecutionStateStore` - 42 edges
5. `KoreaInvestmentBrokerError` - 42 edges
6. `Bar` - 41 edges
7. `RiskSettings` - 41 edges
8. `RecordingTransport` - 39 edges
9. `OrderExecutionEngine` - 38 edges
...
Cohesion: 0.03
Nodes (107): BrokerNormalizationError, Raised when broker payloads cannot be normalized to internal models., _aggregate_intraday_bars(), _build_fill_from_order_history_summary(), _build_fill_notice_subscription_message(), _build_management_order_record_from_submission(), _build_url(), CachedAccessToken (+99 more)
...
Cohesion: 0.03
Nodes (116): SeedUniverseAssetScope, _apply_inspection_updates(), _build_failure_inspection_report(), _build_loss_limit_inspection_item(), _build_market_close_inspection_report(), build_market_close_job(), _build_next_day_preparation(), _daily_fills() (+108 more)

### Community 3 - "Community 3"
Cohesion: 0.05
Nodes (76): create_live_cycle_runtime(), LiveCycleRuntime, _normalize_strategy_kind(), strategy_timeframe_for(), FileExecutionStateStore, _build_market_open_notification(), _build_pre_market_items(), _build_preview_bar() (+68 more)
...
Cohesion: 0.04
Nodes (94): main(), Raised when required settings are missing or invalid., Raised when required settings are missing or invalid., _run_smoke_for_timestamp(), AppSettings, BrokerSettings, TelegramSettings, _approve_symbols() (+86 more)

### Community 6 - "Community 6"
Cohesion: 0.04
Nodes (74): _average_traded_value(), _build_metrics(), build_recommendation_report(), _calculate_return(), _percentile_score(), _rank_candidates(), _realized_volatility(), _resolve_as_of() (+66 more)

### Community 7 - "Community 7"
Cohesion: 0.05
Nodes (68): apply_buy_fill(), apply_sell_fill(), BacktestPortfolioState, BacktestResult, BacktestTrade, build_portfolio_snapshot(), _buy_execution_price(), _calculate_buy_quantity() (+60 more)

### Community 8 - "Community 8"
Cohesion: 0.08
Nodes (70): HttpRequest, HttpResponse, KoreaInvestmentBarSource, KoreaInvestmentBrokerReader, KoreaInvestmentBrokerTrader, ExecutionFill, ExecutionOrder, OrderAmendRequest (+62 more)
...
Cohesion: 0.07
Nodes (31): FileIntradayRiskStateStore, IntradayRiskState, _require_mapping(), _require_optional_decimal(), _require_optional_non_negative_decimal(), _require_optional_positive_decimal(), _require_text(), _serialize_optional_decimal() (+23 more)
...
Cohesion: 0.08
Nodes (29): KrxRegularSessionCalendar, build_weekly_review_report(), build_session_slots(), collect_due_jobs(), _is_stale_slot(), next_scheduled_run_at(), PendingJob, _require_aware_datetime() (+21 more)
